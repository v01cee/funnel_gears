...
async def send_step_message(bot: Bot, step: UserStep, user: User, db):
    ...
    if step.step_name == 'hour_letter':
        ...
        next_step_delay = timedelta(days=1)
        ...
        next_step_delay = timedelta(days=2)
        ...
        message_text = get_product2_letter_message(user.first_name)  # Тот же контент
